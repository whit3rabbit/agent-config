...
Last repository contract review: 2026-05-29.
Last upstream path-contract audit: 2026-05-29.
...
| Google Antigravity | `antigravity` | Prompt: `<root>/.agents/rules/<tag>.md`<br>Legacy status/uninstall: `<root>/.agent/rules/<tag>.md` | `~/.gemini/antigravity/mcp_config.json`, `<root>/.agent/mcp_config.json` | `~/.gemini/antigravity/skills/<name>/`, `<root>/.agents/skills/<name>/`<br>Legacy status/uninstall: `<root>/.agent/skills/<name>/` | `<root>/.agents/rules/<name>.md` (StandaloneFile)<br>Legacy status/uninstall: `<root>/.agent/rules/<name>.md` | Observed | 2026-05-29 upstream audit | `.agents` rules and skills are documented. App-local MCP remains observed; global MCP keeps the existing compatibility path and resolves Antigravity's symlink when present. |
| Antigravity CLI | `antigravitycli` | Prompt: `~/.gemini/GEMINI.md`, `<root>/AGENTS.md` | `~/.gemini/antigravity-cli/mcp_config.json`, `<root>/.agents/mcp_config.json` | - | `~/.gemini/GEMINI.md`, `<root>/AGENTS.md` (InlineBlock) | Observed | 2026-05-29 upstream audit | CLI native skills are flat `.md` files, so `SkillSurface` is deferred. CLI docs disagree on one global MCP path; this crate follows the CLI plugins page. |
